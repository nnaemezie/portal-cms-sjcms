...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: #d12626; border-radius:0px;border-bottom-color:yellow;border-bottom-width:medium;">
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand my-own-brand" href="index.html"><h3>SJCMS</h3></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="main-nav nav navbar-nav navbar-right">
        <li class="wow fadeInDown" data-wow-delay="0.5s"><a class="active" href="http://www.sjcmsportal.com/">Home</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>