        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Settings > Subject <i class="menu-icon mdi mdi-setting"></i></h5>
                            <div class="fluid-container">
                                <div id="myalert"></div>
                                <div>
                                    <form class="form-inline" role="form" id="subject_form">
                                      <div class="form-group">
                                        <input type="text" name="subject" class="form-control" id="subject" placeholder="Example : Mathematics" required>
                                      </div>
                                      &nbsp;&nbsp;
    ...
    <script>
        $(document).ready(function(){
            ...
            function fetch_level(){
                $.ajax({
                    url:"ServerSide/fetch/fetch_subject.php",
                    method:"POST",
                    data:{},
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                url:"ServerSide/delete/delete_subject.php",
                method:"POST",
        ...
        event.preventDefault();
            ...
            $.ajax({
                url:"ServerSide/insert/insert_subject.php",
                method:"POST",
                data:{subject:mysubject},
                success:function(data){
                    $('#myalert').html(data);
                    $.ajax({
                        url:"ServerSide/fetch/fetch_subject.php",
