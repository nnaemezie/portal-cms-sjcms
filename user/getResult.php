...
class PDF extends FPDF {
    ...
    function header(){
        ...
        $this->cell(200,5,'SISTERS OF JESUS CRUCIFIED MODEL SCHOOL',0,0,'C');
        $this->Ln(1);
        /*$this->Image('sign/traco.png',10,10,10);*/
        $this->SetFont('Arial','',8);
        $this->cell(70,20,$this->Image('sign/sjc-logo.png',10,10,22),0,0,'C');
        ...
        $this->Ln(6);
        $this->cell(190,5,'OWALLA URATTA OWERRI NORTH LOCAL GOVERNMENT ',0,0,'C');
        $this->Ln(4);
    ...
    function footer(){
        $this->SetY(-15);
        $this->SetFont('Arial','',8);
        $this->cell(10,10,$this->Image('sign/sjcms-sign.jpg',55,270,40),0,0,'C');
...
$pdf->AliasNbPages();
$pdf->AddPage('P','A4',0);
$pdf->Image('sign/bg_qw.png',10,10,189);
$pdf->headerTable();
$pdf->viewTable($conn);
$pdf->Output();
?>