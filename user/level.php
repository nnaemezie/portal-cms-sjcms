                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="fluid-container">
                                <div id="myalert"></div>
                                <div>
                                    <form class="form-inline" role="form" id="level_form">
                                      <div class="form-group">
                                        <input type="text" name="level" class="form-control" id="level" placeholder="Example : JSS1" required>
                                      </div>
                                      &nbsp;&nbsp;
  ...
  <!-- container-scroller -->
    ...
    <script>
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                url:"ServerSide/delete/delete_level.php",
                method:"POST",
        ...
        event.preventDefault();
            ...
            $.ajax({
                url:"ServerSide/insert/insert_level.php",
                method:"POST",
                data:{level:mylevel},
                success:function(data){
                    $('#myalert').html(data);
