        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">File | Assignment <i class="menu-icon mdi mdi-setting"></i></h5>
    ...
    <script>
        $(document).ready(function(){
            ...
            function fetch_level(){
                ...
                $.ajax({
                    url:"ServerSide/fetch/fetch_assignment.php",
                    method:"POST",
        ...
        $(document).on('click', '.delete', function(){
            ...
            $.ajax({
                url:"ServerSide/delete/delete_assignment.php",
                method:"POST",
