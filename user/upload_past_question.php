        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">File | Upload Past Question <i class="menu-icon mdi mdi-setting"></i></h5>
...
<?php
    if(isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM past_question WHERE subject = '$subject' AND term = '$term' AND class = '$class' ";
        $result = $conn->query($sql);
        if ($result->num_rows > 0) {
            echo '
                <div class="alert alert-warning">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>Waning!</strong> '.$subject.' Past Question  for '.$class.' in respect to '.$term.' already Exist
                </div>
            ';
        }else{
            $sql1 = "INSERT INTO past_question(subject, class, term, file) VALUES('$subject', '$class', '$term', '$file_name')";
            if($conn->query($sql1)){

                $destination     = "file/pastQuestion/".$file_name;
                                ...
                                <form action="" method="post" enctype="multipart/form-data" role="form" id="lessonnote_form">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                <label for="pwd">Upload Past Question</label>
